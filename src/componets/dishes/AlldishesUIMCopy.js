...
const AlldishesUIM = ({
  ...
  const [showvaration, setshowvaration] = useState(true);
    ...
    <Fragment>
      {Type === 'deal' ? (<Fragment>
                        ...
                        dealdish.Deal_ID === Dish_id ? (<Fragment>
                          ...
                          {dealdish.variations === undefined ? '' : (
                            ...
                            dealdish.variations.map((variations, j) => (
                              <Fragment>
                                <button className="btnnnOO" onClick={(e) => handdelvariations(dealdish.Dish_id + j, e)} >Choose {variations.allowed} {variations.varationtype}</button>
        ...
        <div className='grid-itemUM' onClick={(e) => setOpen2(true)}>
          ...
          <h4 onClick={(e) => openpopup(e)}>{Dish_Name}</h4>
          {!image ? (<img
            className='roundimgg'
            src={configData.SERVER_URL + '/public/f5a38c06-8301-427d-bdec-0fba15540a54-dc2781ef-1782-4efb-8918-e4aa4b1f4efb-image-coming-soon2.png'}
            alt='user'
          ...
          <p onClick={(e) => openpopup(e)}>
            {Dish_Description}</p>
          <p className='DishPrice' onClick={(e) => openpopup(e)}> £ {Dish_Price} </p>
              ...
              {showvarationD ? '' : (
                ...
                variations.map((variations, j) => (
                  <Fragment>
                    ...
                    {Dish_id + j === DishIDcheck ? (<Fragment> {showvaration ? '' : (
